...
\begin{figure}[!t]
  ...
  \emph{Right}: cumulative EVR with 90\,\% (amber dashed) and 95\,\% (sienna dashed)
...
why Part~4 results look the way they do.
...
that closes the loop on the Part~1 clustering.
...
K-Means found in Part~1 --- \emph{high-elevation} (CT1/CT2/CT7),
